#ifndef PNEUMATICVALVE32_HPP_INCLUDED
#define PNEUMATICVALVE32_HPP_INCLUDED
...
//!
//! @file PneumaticValve32.hpp
//! @author Petter Krus <petter.krus@liu.se>
//  co-author/auditor **Not yet audited by a second person**
//! @date Mon 3 Aug 2020 16:52:10
//! @brief Pneumatic 32-valve
//! @ingroup PneumaticComponents
//!
//==This code has been autogenerated using Compgen==
//from 
/*{, H:, PettersDropbox, Dropbox, HopsanComponents, PneumaticDevelop, \
PneumaticComponents}/PneumaticValve32.nb*/

using namespace hopsan;

class PneumaticValve32 : public ComponentQ
{
private:
     double Bf;
     double Cf;
...
p3)) + qm32Pos*onPositive(-p2 + p3)));
          ...
          jacobianMatrix[0][7] = -(Cf*p0*p1*Sqrt(T0/T1)*limit((1 + x0 - \
...
p2)*onPositive(-Bf + p2/p1))/(Power(-1 + Bf,2)*Power(p1,2))));
          jacobianMatrix[0][8] = -(Cf*p0*p1*Sqrt(T0/T1)*limit((1 + x0 - \
...
Bf,2)*Power(p2,2)),eps));
          ...
          jacobianMatrix[1][7] = -(Cf*p0*p2*Sqrt(T0/T2)*limit((1 + x0 - \
2*xin)/(-1 + x0),0,1)*(((2*Bf*(p1 - Bf*p2))/(Power(-1 + Bf,2)*Power(p2,2)) + \
(2*Power(p1 - Bf*p2,2))/(Power(-1 + Bf,2)*Power(p2,3)))*dxSignedSquareL(1 - \
Power(p1 - Bf*p2,2)/(Power(-1 + Bf,2)*Power(p2,2)),eps)*onNegative(p1 - \
p2)*onPositive(-Bf + p1/p2) - (2*(-(Bf*p1) + p2)*dxSignedSquareL(1 - \
...
p2)*onPositive(-Bf + p1/p2)*signedSquareL(1 - Power(p1 - Bf*p2,2)/(Power(-1 + \
Bf,2)*Power(p2,2)),eps));
          jacobianMatrix[1][8] = -(Cf*p0*p2*Sqrt(T0/T2)*limit((1 + x0 - \
2*xin)/(-1 + x0),0,1)*((-2*(p1 - Bf*p2)*dxSignedSquareL(1 - Power(p1 - \
Bf*p2,2)/(Power(-1 + Bf,2)*Power(p2,2)),eps)*onNegative(p1 - \
p2)*onPositive(-Bf + p1/p2))/(Power(-1 + Bf,2)*Power(p2,2)) + \
((2*Bf*(-(Bf*p1) + p2))/(Power(-1 + Bf,2)*Power(p1,2)) + (2*Power(-(Bf*p1) + \
...
+ p2/p1)));
          ...
          jacobianMatrix[2][7] = -(Cf*p0*p3*Sqrt(T0/T3)*limit((-1 + x0 + \
...
+ p3/p2)));
          ...
          jacobianMatrix[2][9] = -(Cf*p0*p3*Sqrt(T0/T3)*limit((-1 + x0 + \
...
Power(p2 - Bf*p3,2)/(Power(-1 + Bf,2)*Power(p3,2)),eps)));
          ...
          jacobianMatrix[3][7] = -(Cf*p0*p2*Sqrt(T0/T2)*limit((-1 + x0 + \
2*xin)/(-1 + x0),0,1)*((-2*(p2 - Bf*p3)*dxSignedSquareL(1 - Power(p2 - \
Bf*p3,2)/(Power(-1 + Bf,2)*Power(p3,2)),eps)*onPositive(-Bf + \
p2/p3)*onPositive(-p2 + p3))/(Power(-1 + Bf,2)*Power(p3,2)) + \
((2*Bf*(-(Bf*p2) + p3))/(Power(-1 + Bf,2)*Power(p2,2)) + (2*Power(-(Bf*p2) + \
...
Bf,2)*Power(p3,2)),eps)));
          ...
          jacobianMatrix[3][9] = -(Cf*p0*p2*Sqrt(T0/T2)*limit((-1 + x0 + \
2*xin)/(-1 + x0),0,1)*(((2*Bf*(p2 - Bf*p3))/(Power(-1 + Bf,2)*Power(p3,2)) + \
(2*Power(p2 - Bf*p3,2))/(Power(-1 + Bf,2)*Power(p3,3)))*dxSignedSquareL(1 - \
Power(p2 - Bf*p3,2)/(Power(-1 + Bf,2)*Power(p3,2)),eps)*onPositive(-Bf + \
p2/p3)*onPositive(-p2 + p3) - (2*(-(Bf*p2) + p3)*dxSignedSquareL(1 - \
...
#endif // PNEUMATICVALVE32_HPP_INCLUDED
