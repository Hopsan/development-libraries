...
HEADERS += \
 	PneumaticPistonMass.hpp	
	PneumaticPistonSASpringMass.hpp
	PneumaticPistonSpringMass.hpp
	PneumaticCompressor.hpp
	PneumaticRestrictor.hpp
	PneumaticValve22.hpp
	PneumaticValve32.hpp
	PneumaticValve42.hpp
	PneumaticValve33.hpp
	PneumaticValve43.hpp
	PneumaticValve52.hpp
	PneumaticValve53.hpp
	PneumaticExhaust.hpp
	PneumaticPressureActivation.hpp
	PneumaticVolumeM.hpp
