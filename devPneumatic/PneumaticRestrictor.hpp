#ifndef PNEUMATICRESTRICTOR_HPP_INCLUDED
...
//!
//! @file PneumaticRestrictor.hpp
//! @author Petter Krus <petter.krus@liu.se>
//  co-author/auditor **Not yet audited by a second person**
//! @date Wed 5 Aug 2020 15:48:14
//! @brief Pneumatic restrictor
//! @ingroup PneumaticComponents
//!
//==This code has been autogenerated using Compgen==
//from 
/*{, H:, PettersDropbox, Dropbox, HopsanComponents, PneumaticDevelop, \
PneumaticComponents}/PneumaticRestrictor.nb*/

using namespace hopsan;

class PneumaticRestrictor : public ComponentQ
{
private:
     double Bf;
     double Cf;
...
public:
     ...
     {
        return new PneumaticRestrictor();
     }
    ...
    void simulateOneTimestep()
     {
        ...
        for(iter=1;iter<=mNoiter;iter++)
        {
         ...
         //Differential-algebraic system of equation parts
          ...
          systemEquations[0] =qmP - Cf*p0*p1*Sqrt(T0/T1)*(onNegative(-Bf + \
...
Bf,2)*Power(p2,2)),eps));
          systemEquations[1] =qmN - Cf*p0*p2*Sqrt(T0/T2)*(onNegative(-Bf + \
p1/p2)*onNegative(p1 - p2) + onNegative(-Bf + p2/p1)*onPositive(p1 - p2) + \
onPositive(p1 - p2)*onPositive(-Bf + p2/p1)*signedSquareL(1 - Power(-(Bf*p1) \
+ p2,2)/(Power(-1 + Bf,2)*Power(p1,2)),eps) + onNegative(p1 - \
p2)*onPositive(-Bf + p1/p2)*signedSquareL(1 - Power(p1 - Bf*p2,2)/(Power(-1 + \
...
T1*onPositive(qm2));
          ...
          jacobianMatrix[0][5] = -(Cf*p0*p1*Sqrt(T0/T1)*((-2*(p1 - \
Bf*p2)*dxSignedSquareL(1 - Power(p1 - Bf*p2,2)/(Power(-1 + \
...
Cf*p0*Sqrt(T0/T1)*(onNegative(-Bf + p1/p2)*onNegative(p1 - p2) + \
onNegative(-Bf + p2/p1)*onPositive(p1 - p2) + onPositive(p1 - \
p2)*onPositive(-Bf + p2/p1)*signedSquareL(1 - Power(-(Bf*p1) + \
p2,2)/(Power(-1 + Bf,2)*Power(p1,2)),eps) + onNegative(p1 - \
p2)*onPositive(-Bf + p1/p2)*signedSquareL(1 - Power(p1 - Bf*p2,2)/(Power(-1 + \
Bf,2)*Power(p2,2)),eps));
          jacobianMatrix[0][6] = -(Cf*p0*p1*Sqrt(T0/T1)*(((2*Bf*(p1 - \
Bf*p2))/(Power(-1 + Bf,2)*Power(p2,2)) + (2*Power(p1 - Bf*p2,2))/(Power(-1 + \
...
p2/p1))/(Power(-1 + Bf,2)*Power(p1,2))));
          ...
          jacobianMatrix[1][5] = -(Cf*p0*p2*Sqrt(T0/T2)*((-2*(p1 - \
Bf*p2)*dxSignedSquareL(1 - Power(p1 - Bf*p2,2)/(Power(-1 + \
Bf,2)*Power(p2,2)),eps)*onNegative(p1 - p2)*onPositive(-Bf + \
p1/p2))/(Power(-1 + Bf,2)*Power(p2,2)) + ((2*Bf*(-(Bf*p1) + p2))/(Power(-1 + \
Bf,2)*Power(p1,2)) + (2*Power(-(Bf*p1) + p2,2))/(Power(-1 + \
Bf,2)*Power(p1,3)))*dxSignedSquareL(1 - Power(-(Bf*p1) + p2,2)/(Power(-1 + \
Bf,2)*Power(p1,2)),eps)*onPositive(p1 - p2)*onPositive(-Bf + p2/p1)));
          jacobianMatrix[1][6] = -(Cf*p0*p2*Sqrt(T0/T2)*(((2*Bf*(p1 - \
Bf*p2))/(Power(-1 + Bf,2)*Power(p2,2)) + (2*Power(p1 - Bf*p2,2))/(Power(-1 + \
Bf,2)*Power(p2,3)))*dxSignedSquareL(1 - Power(p1 - Bf*p2,2)/(Power(-1 + \
Bf,2)*Power(p2,2)),eps)*onNegative(p1 - p2)*onPositive(-Bf + p1/p2) - \
(2*(-(Bf*p1) + p2)*dxSignedSquareL(1 - Power(-(Bf*p1) + p2,2)/(Power(-1 + \
Bf,2)*Power(p1,2)),eps)*onPositive(p1 - p2)*onPositive(-Bf + \
p2/p1))/(Power(-1 + Bf,2)*Power(p1,2)))) - Cf*p0*Sqrt(T0/T2)*(onNegative(-Bf \
+ p1/p2)*onNegative(p1 - p2) + onNegative(-Bf + p2/p1)*onPositive(p1 - p2) + \
onPositive(p1 - p2)*onPositive(-Bf + p2/p1)*signedSquareL(1 - Power(-(Bf*p1) \
+ p2,2)/(Power(-1 + Bf,2)*Power(p1,2)),eps) + onNegative(p1 - \
p2)*onPositive(-Bf + p1/p2)*signedSquareL(1 - Power(p1 - Bf*p2,2)/(Power(-1 + \
...
#endif // PNEUMATICRESTRICTOR_HPP_INCLUDED
