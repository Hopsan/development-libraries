#ifndef PNEUMATICPISTONMASS_HPP_INCLUDED
#define PNEUMATICPISTONMASS_HPP_INCLUDED
...
//!
//! @file PneumaticPistonMass.hpp
//! @author Petter Krus <petter.krus@liu.se>
//  co-author/auditor **Not yet audited by a second person**
//! @date Fri 7 Aug 2020 18:21:56
...
PneumaticDevelop}/PneumaticPistonMass.nb*/

using namespace hopsan;

class PneumaticPistonMass : public ComponentQ
{
private:
     double A1;
     double A2;
...
public:
     ...
     {
        return new PneumaticPistonMass();
     }
...
0.5,&mpxmax);
            addInputVariable("mL", "Inertia", "kg", 10.,&mpmL);
...
#endif // PNEUMATICPISTONMASS_HPP_INCLUDED
